...
float Adafruit_MPL3115A2::getPressure() {
  ...
  //initiate data read
  Wire.beginTransmission(MPL3115A2_ADDRESS);	//start transmission to MPL3115A2
  Wire.write(MPL3115A2_REGISTER_PRESSURE_MSB);	//page data MSB register?
  Wire.endTransmission(false);					//end transmission
  
  //request 3 bytes from sensor
