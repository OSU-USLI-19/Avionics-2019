...
byte TX_buffer[size];
byte fakeSerial[] = "$GPRMC,225446,A,4916.45,N,12311.12,W,000.5,054.7,191194,020.3,E*68";
int i;

uint8_t *payloadPacket, *bufferPacket, *packet = new uint8_t[220];
